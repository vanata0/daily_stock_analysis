...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "KPL_ENABLED": {
        ...
        "description": "Enable the KPL (Kaipanla) data source served by a local kpl-unified-client HTTP service. Disabled by default; existing providers are untouched when off.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "KPL_API_BASE": {
        ...
        "description": "Base URL of the kpl-unified-client HTTP service. Must start with http:// or https://. Use host.docker.internal instead of 127.0.0.1 when running in Docker.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "KPL_TIMEOUT": {
        ...
        "description": "Per-request timeout in seconds for KPL HTTP calls.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
...
_FIELD_HELP_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "KPL_ENABLED": {
        "help_key": "settings.data_source.KPL_ENABLED",
        "examples": ["KPL_ENABLED=true"],
        "docs": _DOC_FULL_GUIDE_DATA_SOURCE,
    },
    "KPL_API_BASE": {
        "help_key": "settings.data_source.KPL_API_BASE",
        "examples": [
            "KPL_API_BASE=http://127.0.0.1:8010",
            "KPL_API_BASE=http://host.docker.internal:8010",
        ],
        "docs": _DOC_FULL_GUIDE_DATA_SOURCE,
    },
    "KPL_PRIORITY": {
    ...
    "KPL_TIMEOUT": {
        "help_key": "settings.data_source.KPL_TIMEOUT",
        "examples": ["KPL_TIMEOUT=10"],
        "docs": _DOC_FULL_GUIDE_DATA_SOURCE,
    },
    "SERPAPI_API_KEYS": {
        "help_key": "settings.data_source.search_api_keys",
